...
public class IlonaConnection extends AsyncTask<String,String,String> {
    uni.miskolc.ips.ilona.measurement.model.measurement.Measurement measurement;
    public IlonaConnection(uni.miskolc.ips.ilona.measurement.model.measurement.Measurement measurement) {
